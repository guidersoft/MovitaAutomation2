...
@CucumberOptions(
        features = {"src/test/java/Test/Adem/stepdefs/MyStepdefs_Mvt.java"},// feature dosyasının source path ini yazıyoruz.
       ...
       // tags = "@login2", // Sadece @login2 taglı feature dosyasını çalıştırır, ya da ayrı bir runner class oluşturabiliriz.
        tags = "@MovitaLogo", // istenen feature ya da senaryoya bu tag değeri verilirse Runner dan da sadece onu çalıştırır.
        plugin = { "pretty",
